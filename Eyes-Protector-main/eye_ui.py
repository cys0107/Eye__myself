...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1480, 725)) #白色框框位置大小
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(20, 50, 1500, 800))
        ...
        self.start_push.setGeometry(QtCore.QRect(400, 320, 171, 51))
        ...
        self.initialize_push.setGeometry(QtCore.QRect(400, 280, 171, 51))
        ...
        self.add_push.setGeometry(QtCore.QRect(340, 50, 150, 35)) # "Add"按鍵位置
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.working_time.setGeometry(QtCore.QRect(230, 290, 100, 31))  # "working_time"選框位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Time_Minute_lcdNumber.setGeometry(QtCore.QRect(300, 500, 51, 30))  #minute顯示框框
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Velocity_label_4.setGeometry(QtCore.QRect(20, 430, 101, 30))
        ...
        self.Velocity_Unit_label.setGeometry(QtCore.QRect(340, 290, 50, 30))  #"working_time"的min位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.excerise_count.setGeometry(QtCore.QRect(130, 430, 80, 30))  #"Number"選框位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Serial_Port_Lists_label.setGeometry(QtCore.QRect(30, 15, 101, 31))  #User文字位置
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.blink_bar.setGeometry(QtCore.QRect(340, 160, 221, 31))  #blink的滑動條位置
        ...
        self.distance_threshold.setGeometry(QtCore.QRect(250, 240, 80, 31)) #"distance"選框位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Time_Hour_lcdNumber.setGeometry(QtCore.QRect(185, 500, 51, 30)) #hour顯示框
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.blink_threshold.setGeometry(QtCore.QRect(250, 160, 80, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Velocity_label.setGeometry(QtCore.QRect(20, 290, 200, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Position_Platform_label_3.setGeometry(QtCore.QRect(20, 240, 200, 31))
        font = QtGui.QFont()
        ...
        self.Position_Platform_label_2.setGeometry(QtCore.QRect(20, 200, 250, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Time_Minute_label_2.setGeometry(QtCore.QRect(495, 500, 91,30))  #second文字位置
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Velocity_Unit_label_2.setGeometry(QtCore.QRect(340, 330, 50, 40)) #"resting_time"中min的位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Position_Platform_label.setGeometry(QtCore.QRect(20, 160, 200, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.Progress_progressBar.setGeometry(QtCore.QRect(20, 540, 575, 31))
        ...
        self.resting_time.setGeometry(QtCore.QRect(250, 330, 80, 31))  # "resting_time"選框位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.confirm_push.setGeometry(QtCore.QRect(340, 10, 150, 35)) # "confirm"案件位置
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.recommend_push = QtWidgets.QPushButton(self.frame)
        self.recommend_push.setEnabled(False)
        self.recommend_push.setGeometry(QtCore.QRect(400, 360, 171, 51)) # "Recommend"按鍵位置
        sizePolicy.setHeightForWidth(self.recommend_push.sizePolicy().hasHeightForWidth())
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        self.recommend_push.setSizePolicy(sizePolicy)
        self.recommend_push.setObjectName("Recommend")

        self.bright_threshold = QtWidgets.QDoubleSpinBox(self.frame)
        self.bright_threshold.setEnabled(True)
        self.bright_threshold.setGeometry(QtCore.QRect(250, 200, 80, 31))  #"bright"選框位置大小
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Time_Second_lcdNumber.setGeometry(QtCore.QRect(440, 500, 51, 30)) #second顯示框
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.user_list.setGeometry(QtCore.QRect(160, 10, 161, 31))
        self.user_list.setObjectName("user_list")
        self.Time_Hour_label = QtWidgets.QLabel(self.frame)
        self.Time_Hour_label.setGeometry(QtCore.QRect(240, 500, 70, 30))  #Hour文字位置
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.bright_bar.setGeometry(QtCore.QRect(340, 200, 221, 31))  #bright的滑動條位置
        ...
        self.Velocity_label_3.setGeometry(QtCore.QRect(20, 380, 101, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.add_user.setGeometry(QtCore.QRect(160, 50, 161, 31)) #Add User選框位置
        self.add_user.setObjectName("add_user")
        self.Serial_Port_Lists_label_2 = QtWidgets.QLabel(self.frame)
        self.Serial_Port_Lists_label_2.setGeometry(QtCore.QRect(30, 50, 150, 40)) #Add User文字位置
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.Velocity_label_2.setGeometry(QtCore.QRect(20, 330, 200, 40))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.exercise.setGeometry(QtCore.QRect(150, 380, 161, 31))
        self.exercise.setObjectName("exercise")
        self.Time_Minute_label = QtWidgets.QLabel(self.frame)
        self.Time_Minute_label.setGeometry(QtCore.QRect(355, 500, 80, 30)) #minute文字位置
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Time_Title_label.setGeometry(QtCore.QRect(20, 500, 155, 30))  #計時標題文字位置
        ...
        self.distance_bar.setGeometry(QtCore.QRect(340, 240, 221, 31)) #distance滑動條位置
        ...
        self.camera_label.setGeometry(QtCore.QRect(600, 50, 6400, 480))
        self.camera_label.setText("")
        self.camera_label.setObjectName("camera_label")
        self.line_token = QtWidgets.QLineEdit(self.frame)
        self.line_token.setEnabled(False)
        self.line_token.setGeometry(QtCore.QRect(190, 100, 301, 35))#User Line輸入框位置
        ...
        self.want_line.setGeometry(QtCore.QRect(160,120, 150, 35))  #Line勾選框框位置
        ...
        self.Serial_Port_Lists_label_5.setGeometry(QtCore.QRect(30, 100, 160, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 570, 500, 51))   #最後一行文字位置
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(528, 580, 58, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Eye Myself"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.main), _translate("Dialog", "主頁"))
        ...
        self.Serial_Port_Lists_label.setText(_translate("Dialog", "User"))
        ...
        self.label_2.setText(_translate("Dialog", "為提供更完善的客製化服務，請填寫後測:"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p><a href=\"https://docs.google.com/forms/d/13oD8K_yynYT2hB6fNbvKYj9VThIW1GHar9BT87t6Tqw/edit\"><span style=\" text-decoration: underline; color:#0000ff;\">Link</span></a></p></body></html>"))
        self.label_4.setText(_translate("Dialog", "Plot Range :"))
        self.Serial_Port_Lists_label_3.setText(_translate("Dialog", "Choose User :"))
        self.recommend_push.setText(_translate("Dialog", "Recommend"))
